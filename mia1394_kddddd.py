...
lon_min, lon_max = min(df_events.longitude), max(df_events.longitude)
lat_min, lat_max = min(df_events.latitude), max(df_events.latitude)
...
m4a.drawmapboundary(fill_color='#add8e6')                # black background
...
m4b.drawmapboundary(fill_color='#add8e6')                # black background
