...
masks.head() # 2 variables of masks
fig, (ax1, ax2) = plt.subplots(1, 2, figsize = (10, 5)) #Plotting Grid ax1 and ax2 are columns
...
print('Check Decoding->Encoding',
      ...
      'RLE_1:', len(rle_1))
masks['ships'] = masks['EncodedPixels'].map(lambda c_row: 1 if isinstance(c_row, str) else 0) #create column ships with 0 or 1
