...
def model_bilstm_attention(embedding_matrix):
    ...
    l = Bidirectional(CuDNNLSTM(64, return_sequences=True))(x)
    g = Bidirectional(CuDNNGRU(64, return_sequences=True))(x)
    x = concatenate([l, g])
    x = Bidirectional(CuDNNLSTM(64//2, return_sequences=True))(x)
