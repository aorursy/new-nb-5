...
# Any results you write to the current direc
...
test_generator = test_datagen.flow_from_directory("../input/test1",target_size=(64, 64),batch_size=32,class_mode='binary')
