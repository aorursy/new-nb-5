...
#train = pd.read_csv('/kaggle/input/train-doctored/trainDoctored.csv')

train = pd.read_csv('/kaggle/input/traincoord/train_proc.csv')

#test = pd.read_csv('/kaggle/input/covid19-global-forecasting-week-3/test.csv')

test = pd.read_csv('/kaggle/input/test-coord/test_proc.csv')

subs = pd.read_csv('/kaggle/input/covid19-global-forecasting-week-3/submission.csv')
...
# train = pd.merge(train,train_groupped[['Province_State','Country_Region','Lat','Long']])
...
# test = pd.merge(test,test_groupped[['Province_State','Country_Region','Lat','Long']])
