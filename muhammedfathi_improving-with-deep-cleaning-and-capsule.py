...
train = pd.read_csv('../input/more-text-cleaning-to-increase-word-coverage/cleaned_train.csv')

test = pd.read_csv("../input/more-text-cleaning-to-increase-word-coverage/cleaned_test.csv")
