...
fig = px.bar(df_worldinfor.sort_values('Total Cases', ascending=False)[:20][::-1], 
...
fig = px.bar(df_worldinfor.sort_values('Cases', ascending=False)[:20][::-1], 
...
fig = px.bar(df_worldinfor.sort_values('Active Case', ascending=False)[:20][::-1], 
