...
#     print('Found embeddings for  {:.2%} of all text'.format(nb_known_words / (nb_known_words + nb_unknown_words)))
    ...
    return (nb_known_words / (nb_known_words + nb_unknown_words))
...
def get_processed_data():
    ...
    if oov_glove > oov_paragram and oov_globe > oov_fasttext:
        embedding = '../input/embeddings/glove.840B.300d/glove.840B.300d.txt'
        print("Glove embedding are the best with " + str(oov_glove)+" match.")
    elif oov_paragram > oov_glove and oov_paragram > oov_fasttext:
        embedding = '../input/embeddings/paragram_300_sl999/paragram_300_sl999.txt'
        print("Paragram embedding are the best with " + str(oov_paragram)+" match.")
    else:
        embedding = '../input/embeddings/wiki-news-300d-1M/wiki-news-300d-1M.vec'
        print("Wiki-News embedding are the best with " + str(oov_fasttext)+" match.")
