...
m1.drawmapboundary(fill_color='#a1d3f3')                # black background
m1.drawcountries(linewidth=0.1, color="w")              # thin white line for country borders

# Plot the data
mxy = m1(df_events_sample["longitude"].tolist(), df_events_sample["latitude"].tolist())
m1.scatter(mxy[0], mxy[1], s=3, c="#fff335", lw=0, alpha=1, zorder=5)
...
m2.drawmapboundary(fill_color='#a1d3f3')                # black background
...
m4a.drawmapboundary(fill_color='#a1d3f3')                # black background
...
m4a.scatter(mxy[0], mxy[1], s=5, c="#228b22", lw=0, alpha=0.1, zorder=5)
...
m4b.drawmapboundary(fill_color='#a1d3f3')                # black background
